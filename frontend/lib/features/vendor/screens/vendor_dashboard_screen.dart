...
class _VendorDashboardScreenState extends State<VendorDashboardScreen>
  ...
  void _showNegotiateDialog(BuildContext context, String orderId, int price) {
    // Placeholder for negotiation dialog
  }

  void _acceptJob(BuildContext context, String orderId) {
    // Placeholder for accept job logic
  }
}
                mainAxisSize: MainAxisSize.min,
                children: [
